...
NioApp = (function(f, b, d, n) {
    ...
    (b.fn.exists = function() {
        ...
        (f.getStatus = {}),
        (f.getStatus.isRTL = !(
            !l.hasClass("has-rtl") && "rtl" !== l.attr("dir")
        )),
        (f.getStatus.isTouch = "ontouchstart" in n.documentElement),
        (f.getStatus.isMobile = !!navigator.userAgent.match(
        ...
        (f.Util.classInit = function() {
            function a() {
                !0 === f.getStatus.asMobile
                    ? l.addClass("as-mobile")
                    : l.removeClass("as-mobile");
            }
            !0 === f.getStatus.isTouch
                ? l.addClass("has-touch")
                : l.addClass("no-touch"),
                a(),
                "rtl" === l.attr("dir") &&
                    (l.addClass("has-rtl"), (f.getStatus.isRTL = !0)),
                b(d).on("resize", a);
        }),
        ...
        (f.Util.headerSearch = function() {
            ...
            e.on("click", function(a) {
                ...
                a.on("click", function(a) {
                    b(a.target).is(".input-search") ||
                        (s.hasClass("search-show") &&
        ...
        (f.Util.browser = function() {
            var a = -1 !== navigator.userAgent.indexOf("Chrome") ? 1 : 0,
                ...
                t =
                    -1 !== navigator.userAgent.indexOf("MSIE") || n.documentMode
                        ? 1
                        : 0,
                i = !t && !!d.StyleMedia,
                o =
        ...
        f.components.docReady.push(f.Util.Ovm),
        (f.Util.toggler = function() {
            var t = ".toggle-tigger",
                i = ".toggle-class";
            b(t).exists() &&
                p.on("click", t, function(a) {
                    var e = b(this);
                    b(t)
                        .not(e)
                        .removeClass("active"),
        ...
        f.components.docReady.push(f.Util.toggler),
        (f.Util.accordionActive = function() {
        ...
        f.components.docReady.push(f.Util.accordionActive),
        (f.Util.scrollAnimation = function() {
            var a = b(".animated");
            b().waypoint &&
                a.exists() &&
                a.each(function() {
                    ...
                    a.waypoint(
                        function() {
                            a
                                ...
                                s && a.css("animation-duration", s + "s"),
                                t && a.css("animation-delay", t + "s");
                        },
                        { offset: "93%" }
                    );
                });
        }),
        f.components.winLoad.push(f.Util.scrollAnimation),
        (f.Util.Counter = function() {
            var a = b(".count"),
        ...
        f.components.winLoad.push(f.Util.Counter),
                        ...
                        i.exists() &&
                            i.on("click", function(a) {
                                var e = b(this),
                                    s = e.parent();
                                (c.width() < u ||
                                    e.hasClass("menu-toggle-alt")) &&
                                    (s.children(n).slideToggle(400),
                                    s
                                        .siblings()
                                        .children(n)
                                        .slideUp(400),
                                    s.toggleClass(l),
                                    s.siblings().removeClass(l)),
                                    a.preventDefault();
                            });
                    },
                    mobileNav: function() {
                        c.width() < u
                            ? s.delay(500).addClass(m)
                            : (s.delay(500).removeClass(m),
                              e.removeClass("active"),
                              s.removeClass(r));
                    },
            ...
            b('a.menu-link[href*="#"]:not([href="#"])').on("click", function() {
                if (
                    ...
                    var a = this.hash,
                        e =
                            !!this.hash.slice(1) &&
                            b("[name=" + this.hash.slice(1) + "]"),
                        s = a.length ? b(a) : e;
                    if (s.length)
                        return (
                            b(".navbar-toggle").removeClass("active"),
                            b(".header-navbar").removeClass("menu-shown"),
                            b("html, body")
                                .delay(150)
                                .animate(
        ...
        f.components.docReady.push(f.OnePageScroll),
                ...
                a.each(function() {
                    var a = b(this),
                        ...
                        s = a.data("items-tab-l")
                            ...
                            : e - 1,
                        t =
                            (a.data("items-tab-p") && a.data("items-tab-p"),
                            a.data("items-mobile")
                                ? a.data("items-mobile")
                                : 1),
                    ...
                    1 === e && (s = t = 1),
                        ...
                        a.slick({
                            ...
                            responsive: [
                                {
                                    breakpoint: 1200,
                                    settings: { slidesToShow: e }
                                },
                                {
                                    breakpoint: 992,
                                    settings: { slidesToShow: s }
                                },
                                {
                                    breakpoint: 767,
                                    settings: { slidesToShow: s }
                ...
                a.each(function() {
                    var a = b(this),
                        e = a.data("select2-theme")
                            ...
                            : "bordered",
                        s = a.data("select2-placehold")
                            ? a.data("select2-placehold")
                            : "Select an option";
                    a.select2({ placeholder: s, theme: "default select-" + e });
                });
        }),
        f.components.docReady.push(f.Plugins.select2),
        (f.Plugins.validform = function() {
        ...
        f.components.docReady.push(f.Plugins.validform),
        (f.Plugins.submitform = function() {
            var a = b(".Golox-form");
            if (!b().validate && !b().ajaxSubmit)
                return (
        ...
        f.components.docReady.push(f.Plugins.submitform),
        (f.Plugins.popup = function() {
                                    ...
                                    callbacks: {
                                        beforeOpen: function() {
                                            (this.st.image.markup = this.st.image.markup.replace(
                                                ...
                                                (this.st.mainClass = this.st.el.attr(
                                                    "data-effect"
                                                ));
                                        }
                                    }
        ...
        f.components.docReady.push(f.Plugins.popup),
        (f.Plugins.twitterfeed = function() {
            var a = "tweets_feed";
            if (b("#" + a).exists()) {
                var e = {
                    profile: { screenName: "Golox" },
                    domId: a,
                    maxTweets: 3,
                    enableLinks: !0,
                    showUser: !1,
        ...
        f.components.winLoad.push(f.Plugins.twitterfeed),
        (f.Plugins.datepicker = function() {
            b(".datepicker").datepicker();
        }),
        f.components.winLoad.push(f.Plugins.datepicker),
        (f.Plugins.lineanimate = function() {
            b(".line-animate").addClass("active");
        }),
        f.components.winLoad.push(f.Plugins.lineanimate),
        (f.Plugins.filterz = function() {
            var a = b(".project"),
                e = b(".project-filter li");
            a.each(function() {
                var a = b(this),
                    e = a.data("layout") ? a.data("layout") : "packed";
                b(this).filterizr({ layout: e });
            }),
                e.on("click", function() {
                    e.removeClass("active"), b(this).addClass("active");
                });
        }),
        f.components.winLoad.push(f.Plugins.filterz),
            ...
            a.exists() &&
                a.each(function() {
                    ...
                    e.hasClass("has-bg-video") || e.addClass("has-bg-video"),
                        n
                            ? a.hasClass("overlay-" + n) ||
                              (a.addClass("overlay"),
                              a.addClass("overlay-" + n))
                            : a.hasClass("overlay-fall") ||
                              a.addClass("overlay-fall"),
                        l && a.addClass("overlay-opacity-" + l),
                        r &&
                            f.getStatus.isTouch &&
                            f.getStatus.isMobile &&
